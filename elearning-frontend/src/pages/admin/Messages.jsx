...
export default function Messages() {
  ...
  return (
   <div className="w-full h-screen grid grid-cols-[300px_1fr] bg-gray-100 overflow-hidden">

  <div className="bg-white border-r shadow-md p-4 overflow-y-auto min-h-0">
  ...
  <div className="flex flex-col h-full min-h-0">
    ...
    <div className="bg-white p-4 shadow-md border-b">
      <h2 className="text-xl font-semibold">
        {activeUser ? `Chat with: ${activeUser.fullname}` : "Select a user"}
      </h2>
    </div>
