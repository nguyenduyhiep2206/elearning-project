...
// Lưu ý: Đặt các route cụ thể trước route có parameter để tránh conflict
...
router.get('/:courseId', courseController.getCourseById); // Lấy khóa học theo ID (phải đặt cuối cùng)
